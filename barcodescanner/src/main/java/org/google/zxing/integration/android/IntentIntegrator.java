...
package org.google.zxing.integration.android;
...
public class IntentIntegrator {
  ...
  private static final String BS_PACKAGE = "org.google.zxing.client.android";
   ...
   *
   * @param text the text string to encode as a barcode
   * @param type type of data to encode. See {@code org.google.zxing.client.android.Contents.Type} constants.
   * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
   *   if a prompt was needed, or null otherwise
   */
